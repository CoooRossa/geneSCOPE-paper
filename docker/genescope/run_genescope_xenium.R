...
# NOTE: The frozen v1.2.0 Xenium constructor does not expose a
# `parallel_backend` argument. ROI clipping therefore uses the constructor's
# native runtime path; `ncores` remains explicit for the supported stages.
