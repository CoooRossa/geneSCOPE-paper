...
.lee_l <- function(...) lee_L(...)
.lee_l_cache <- function(...) lee_L_cache(...)
.lee_l_cols <- function(...) lee_L_cols(...)
.lee_perm <- function(...) lee_perm(...)
.lee_perm_block <- function(...) lee_perm_block(...)

.idelta_sparse_cpp <- function(...) idelta_sparse_cpp(...)

.pearson_block_cpp <- function(...) pearson_block_cpp(...)
.pearson_cor <- function(...) pearson_cor(...)
