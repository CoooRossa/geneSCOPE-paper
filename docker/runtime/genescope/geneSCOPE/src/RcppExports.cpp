...
// module_quality_perm_null
Rcpp::List module_quality_perm_null(const IntegerVector membership, const IntegerVector u, const IntegerVector v, const NumericVector w, const int n_perm, const int seed, const bool do_member, const bool do_module, const bool do_conductance);
RcppExport SEXP _geneSCOPE_module_quality_perm_null(SEXP membershipSEXP, SEXP uSEXP, SEXP vSEXP, SEXP wSEXP, SEXP n_permSEXP, SEXP seedSEXP, SEXP do_memberSEXP, SEXP do_moduleSEXP, SEXP do_conductanceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const IntegerVector >::type membership(membershipSEXP);
    Rcpp::traits::input_parameter< const IntegerVector >::type u(uSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type seed(seedSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_member(do_memberSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_module(do_moduleSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_conductance(do_conductanceSEXP);
    rcpp_result_gen = Rcpp::wrap(module_quality_perm_null(membership, u, v, w, n_perm, seed, do_member, do_module, do_conductance));
    return rcpp_result_gen;
END_RCPP
}
// test_64bit_support
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_geneSCOPE_module_quality_perm_null", (DL_FUNC) &_geneSCOPE_module_quality_perm_null, 9},
