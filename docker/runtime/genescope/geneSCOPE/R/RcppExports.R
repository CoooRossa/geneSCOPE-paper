...
module_quality_perm_null <- function(membership, u, v, w, n_perm = 50L, seed = 1L, do_member = TRUE, do_module = TRUE, do_conductance = TRUE) {
    .Call(`_geneSCOPE_module_quality_perm_null`, membership, u, v, w, n_perm, seed, do_member, do_module, do_conductance)
}
